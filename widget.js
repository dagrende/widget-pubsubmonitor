...
cprequire_test(["inline:dr-widget-pubsubmonitor"], function(myWidget) {
...
cpdefine("inline:dr-widget-pubsubmonitor", ["chilipeppr_ready", /* other dependencies here */ ], function() {
    return {
        /**
         * The ID of the widget. You must define this and make it unique.
         */
        id: "dr-widget-pubsubmonitor", // Make the id the same as the cpdefine id
        name: "Widget / Pub-Sub Monitor", // The descriptive name of your widget.
        desc: "Lists signals published by other widgets.", // A description of what your widget does
         ...
         */
        init: function() {
            console.log("pubsubmonitor being initted.");

            this.setupUiFromLocalStorage();
            this.btnSetup();
            this.forkSetup();

            console.log("pubsubmonitor init.");
        },
        /**
