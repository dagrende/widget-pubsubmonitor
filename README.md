# dr-widget-pubsubmonitor
Lists signals published by other widgets.

![alt text](screenshot.png "Screenshot")

## ChiliPeppr Widget / Pub-Sub Monitor
...
| Item                  | Value           |
| -------------         | ------------- | 
| ID                    | dr-widget-pubsubmonitor |
| Name                  | Widget / Pub-Sub Monitor |
| Description           | Lists signals published by other widgets. |
| chilipeppr.load() URL | http://raw.githubusercontent.com/dagrende/widget-pubsubmonitor/master/auto-generated-widget.html |
| Edit URL              | http://ide.c9.io/dagrende/widget-pubsubmonitor |
| Github URL            | http://github.com/dagrende/widget-pubsubmonitor |
| Test URL              | https://preview.c9users.io/dagrende/widget-pubsubmonitor/widget.html |
...
$("body").append('<' + 'div id="myDivDrWidgetPubsubmonitor"><' + '/div>');

chilipeppr.load(
  "#myDivDrWidgetPubsubmonitor",
...
To better understand how ChiliPeppr's subscribe() method works see amplify.js's documentation at http://amplifyjs.com/api/pubsub/
  ...
  <table id="com-chilipeppr-elem-pubsubviewer-pub" class="table table-bordered table-striped">
      ...
      <tbody>
      <tr valign="top"><td>/dr-widget-pubsubmonitor/onExampleGenerate</td><td>Example: Publish this signal when we go to generate gcode.</td></tr>    
      </tbody>
  </table>
...
The table below shows, in order, the methods and properties inside the widget/element.
  ...
  <table id="com-chilipeppr-elem-methodsprops" class="table table-bordered table-striped">
      ...
      <tbody>
      <tr valign="top"><td>id</td><td>string</td><td>"dr-widget-pubsubmonitor"<br><br>The ID of the widget. You must define this and make it unique.</td></tr><tr valign="top"><td>name</td><td>string</td><td>"Widget / Pub-Sub Monitor"</td></tr><tr valign="top"><td>desc</td><td>string</td><td>"Lists signals published by other widgets."</td></tr><tr valign="top"><td>url</td><td>string</td><td>"http://raw.githubusercontent.com/dagrende/widget-pubsubmonitor/master/auto-generated-widget.html"</td></tr><tr valign="top"><td>fiddleurl</td><td>string</td><td>"http://ide.c9.io/dagrende/widget-pubsubmonitor"</td></tr><tr valign="top"><td>githuburl</td><td>string</td><td>"http://github.com/dagrende/widget-pubsubmonitor"</td></tr><tr valign="top"><td>testurl</td><td>string</td><td>"http://widget-pubsubmonitor-dagrende.c9users.io/widget.html"</td></tr><tr valign="top"><td>publish</td><td>object</td><td>Please see docs above.<br><br>Define the publish signals that this widget/element owns or defines so that
